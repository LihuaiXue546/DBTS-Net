...
class SPELayer(nn.Module):
    """Constructs a SPE (Small-target Perceptual Enhancement) module.
    Args:
        channel: Number of channels of the input feature map
        k_size: Adaptive selection of kernel size
    """
    def __init__(self, channel, k_size=3):
        super(SPELayer, self).__init__()
    ...
    def forward(self, x):
        ...
        # Two different branches of SPE module
...
# 保留原始eca_layer类以保持向后兼容性
class eca_layer(SPELayer):
    def __init__(self, channel, k_size=3):
        super().__init__(channel, k_size)
